document.getElementById('registro-form').addEventListener('submit', function(event) {
    ...
    // Guardar el usuario
    const registrado = registrarUsuario(correoElectronico, password);

    if (registrado) {
        document.getElementById('res').innerHTML = `<p>Su gmail es: ${correoElectronico}</p>`;
        document.getElementById('contrasena').innerHTML = `<p>Su contraseña es: ${password}</p>`;
    }
});
